...
public class dashboard extends AppCompatActivity {
    ...
    private final String urlAddress = "http://wbkanyashree.gov.in/kp_app/kp_total_appl_unique";

    private String jsonStr = null;
    private String flag = "unique";
    ...
    private String getResponse() throws UnsupportedEncodingException {
        ...
        data += "&" +  URLEncoder.encode("flag","UTF-8") + "=" + URLEncoder.encode(flag,"UTF-8");
